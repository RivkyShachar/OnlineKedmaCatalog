...
namespace OnlinePizzaWebApplication.Controllers
{
    ...
    public async Task<IActionResult> GeneratePdf()

        {
            ...
            using (FileStream fs = new FileStream(@"C:\\Users\\yaeli\\Desktop\\h.pdf", FileMode.Create, FileAccess.Write, FileShare.Read))
            {
...
//        message.From = new MailAddress("yaeligloiberman@gmail.com", "Kedma");
