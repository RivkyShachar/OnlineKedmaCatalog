    ...
    public async Task<IActionResult> GeneratePdf()
        ...
        public async Task<IActionResult> GenerateAndSendPdf()
        {
            ...
            using (var memoryStream = new MemoryStream())
            {
                ...
                //message.Body = multipart.ToString();
        ...
        //        emailMessage.From.Add(new MailboxAddress("Sender Name", "rvider@g.jct.ac.il"));
        //        emailMessage.To.Add(new MailboxAddress("Recipient Name", "rvider@g.jct.ac.il"));
        //        emailMessage.Subject = "Shopping Cart Invoice";
        ...
        public void SendMailShira(string pdfFilePath)
        {
            try
            {
                MailMessage mail = new MailMessage();
                mail.To.Add("rvider@g.jct.ac.il");
                mail.From = new MailAddress("dronedrop2021@gmail.com");
                mail.Subject = "Get a new Password";
                mail.Body = "Hi";
                ...
                {
                    UseDefaultCredentials = false,
                    Credentials = new NetworkCredential("dronedrop2021@gmail.com", "ouiatjczzhkvtxnr"),
                    EnableSsl = true
                };
...
//[HttpPost]
//public IActionResult SendEmailShira()
//{
