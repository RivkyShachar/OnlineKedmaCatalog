...
namespace OnlinePizzaWebApplication.Controllers
{
    public class PizzasOldController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Barcode,Weight, Description,ImageUrl")] Pizzas pizza)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Barcode,Weight, Description,ImageUrl")] Pizzas pizza)
        {
            if (id != pizza.Id)
            {
                return NotFound();
